...
> #### Note:
>
> - `Source` is an **_asynchronously rendered_** component.
...
The `Source` component uses [Prettier](https://prettier.io/) to automatically format your `code` string.

If you do not wish to use this functionality, it can be disabled with `format`:

<Story of={SourceStories.Unformatted} />

> #### Note:
>
> - If the `format` is enabled the formatting will apply a trailing semicolon.
> - You can prevent this by enabling the `removeTrailingSemicolon` option.
...
<Story of={SourceStories.ComponentExample} />

<Story of={SourceStories.ComponentExampleRaw} />

<Story of={SourceStories.ComponentExampleRawDisplayedSource} />
